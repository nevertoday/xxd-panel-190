---
name: xxd-panel-190
description: "Create Panel 190 raster artwork: Naive Cool Pastel with Warm Accents. Use when the user invokes xxd-panel-190 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-190/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-190-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
